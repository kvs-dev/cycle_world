...
from adapaters.Questions_Service import AVG_JOURNEY_DURATION,Stations_More_Crowded, Percentage_By_Journeys, Bike_Color
...
show_metrics = Cards()
show_metrics.render(percentage_by_journeys, avg_journey_duration, bike_color, st)
